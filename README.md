...
# Requirements: 
- Your application should login the user who is using a Google Account.
...
Notes: During the in-person interview we will walk through your application so please be ready with your laptop. There is no time limit for this test. You are free to use any reasonable amount of time you need.
...
To optimize the finra_assignment client for production, run:
...
* Project name: `finra_assignment`
* Source Code Management
    * Git Repository: `git@github.com:xxxx/finra_assignment.git`
