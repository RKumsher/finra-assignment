        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('finraAssignmentApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-finraAssignmentApp-error');
                                var entityKey = httpResponse.headers('X-finraAssignmentApp-params');
                                if (errorHeader) {
